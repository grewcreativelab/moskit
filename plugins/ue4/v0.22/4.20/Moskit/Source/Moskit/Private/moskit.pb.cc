...
namespace MSAnalyzer {
	namespace MOSKIT_UNITY_LIB {
		...
		namespace {
			...
			const ::google::protobuf::Descriptor* AnalysisBuffer_descriptor_ = NULL;
			const ::google::protobuf::internal::GeneratedMessageReflection*
				AnalysisBuffer_reflection_ = NULL;
		...
		void protobuf_AssignDesc_moskit_2eproto() {
			...
			static const int MainCamera_offsets_[10] = {
				...
				GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(MainCamera, fieldofview_),
				...
				GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(MainCamera, fipd_),
				GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(MainCamera, list_component_),
			};
			...
			Controller_descriptor_ = file->message_type(4);
			static const int Controller_offsets_[7] = {
				GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(Controller, name_),
				GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(Controller, active_),
				GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(Controller, layer_),
				GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(Controller, instanceid_),
				GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(Controller, tag_),
				GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(Controller, transform_),
				GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(Controller, list_component_),
			};
			Controller_reflection_ =
				::google::protobuf::internal::GeneratedMessageReflection::NewGeneratedMessageReflection(
					Controller_descriptor_,
					Controller::internal_default_instance(),
					Controller_offsets_,
					GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(Controller, _has_bits_),
					-1,
					-1,
					sizeof(Controller),
					GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(Controller, _internal_metadata_));
			...
			static const int GameObject_offsets_[9] = {
				...
				GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(GameObject, list_component_),
			};
			...
			static const int Scene_offsets_[8] = {
				...
				GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(Scene, fscaleratio_),
				GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(Scene, bvsync_),
				GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(Scene, analysis_buffer_),
				GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(Scene, list_controller_),
			...
			ArrayScene_descriptor_ = file->message_type(8);
			...
			AnalysisBuffer_descriptor_ = file->message_type(9);
			static const int AnalysisBuffer_offsets_[4] = {
				GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(AnalysisBuffer, list_int_),
				GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(AnalysisBuffer, list_float_),
				GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(AnalysisBuffer, list_string_),
				GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(AnalysisBuffer, list_vector3_),
			};
			AnalysisBuffer_reflection_ =
				::google::protobuf::internal::GeneratedMessageReflection::NewGeneratedMessageReflection(
					AnalysisBuffer_descriptor_,
					AnalysisBuffer::internal_default_instance(),
					AnalysisBuffer_offsets_,
					GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(AnalysisBuffer, _has_bits_),
					-1,
					-1,
					sizeof(AnalysisBuffer),
					GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(AnalysisBuffer, _internal_metadata_));
		}
		...
		namespace {
			...
			void protobuf_RegisterTypes(const ::std::string&) {
				...
				::google::protobuf::MessageFactory::InternalRegisterGeneratedMessage(
					Controller_descriptor_, Controller::internal_default_instance());
				::google::protobuf::MessageFactory::InternalRegisterGeneratedMessage(
				...
				::google::protobuf::MessageFactory::InternalRegisterGeneratedMessage(
					AnalysisBuffer_descriptor_, AnalysisBuffer::internal_default_instance());
			}
		...
		void protobuf_ShutdownFile_moskit_2eproto() {
			...
			Controller_default_instance_.Shutdown();
			...
			AnalysisBuffer_default_instance_.Shutdown();
			delete AnalysisBuffer_reflection_;
		}
		...
		void protobuf_InitDefaults_moskit_2eproto_impl() {
			...
			::google::protobuf::internal::GetEmptyString();
			Controller_default_instance_.DefaultConstruct();
			...
			::google::protobuf::internal::GetEmptyString();
			AnalysisBuffer_default_instance_.DefaultConstruct();
			...
			Controller_default_instance_.get_mutable()->InitAsDefaultInstance();
			...
			AnalysisBuffer_default_instance_.get_mutable()->InitAsDefaultInstance();
		}
		...
		void protobuf_AddDesc_moskit_2eproto_impl() {
			...
			::google::protobuf::DescriptorPool::InternalAddGeneratedFile(
				...
				"\001(\005\022\013\n\003tag\030\005 \001(\t\022\023\n\013FieldOfView\030\006 \001(\002\0229\n"
				"\ttransform\030\007 \001(\0132&.MSAnalyzer.MOSKIT_UNI"
				"TY_LIB.Transform\0226\n\010hitpoint\030\010 \001(\0132$.MSA"
				"nalyzer.MOSKIT_UNITY_LIB.Vector3\022\014\n\004fIPD"
				"\030\t \001(\002\022>\n\016list_Component\030\n \003(\0132&.MSAnaly"
				"zer.MOSKIT_UNITY_LIB.Component\"\031\n\tCompon"
				"ent\022\014\n\004name\030\001 \001(\t\"\325\001\n\nController\022\014\n\004name"
				"\030\001 \001(\t\022\016\n\006active\030\002 \001(\010\022\r\n\005layer\030\003 \001(\005\022\022\n"
				"\ninstanceID\030\004 \001(\005\022\013\n\003tag\030\005 \001(\t\0229\n\ttransf"
				"orm\030\006 \001(\0132&.MSAnalyzer.MOSKIT_UNITY_LIB."
				"Transform\022>\n\016list_Component\030\007 \003(\0132&.MSAn"
				"alyzer.MOSKIT_UNITY_LIB.Component\";\n\004Tim"
				"e\022\021\n\tdeltaTime\030\001 \001(\002\022\022\n\nframeCount\030\002 \001(\005"
				"\022\014\n\004time\030\003 \001(\002\"\370\001\n\nGameObject\022\014\n\004name\030\001 "
				"\001(\t\022\016\n\006active\030\002 \001(\010\022\020\n\010isStatic\030\003 \001(\010\022\r\n"
				"\005layer\030\004 \001(\005\022\022\n\ninstanceID\030\005 \001(\005\022\013\n\003tag\030"
				"\006 \001(\t\0229\n\ttransform\030\007 \001(\0132&.MSAnalyzer.MO"
				"SKIT_UNITY_LIB.Transform\022\017\n\007strType\030\010 \001("
				"\t\022>\n\016list_Component\030\t \003(\0132&.MSAnalyzer.M"
				"OSKIT_UNITY_LIB.Component\"\365\002\n\005Scene\022\023\n\013s"
				"trIndicate\030\001 \001(\t\022/\n\004time\030\002 \001(\0132!.MSAnaly"
				"zer.MOSKIT_UNITY_LIB.Time\0227\n\006Camera\030\003 \001("
				"\0132\'.MSAnalyzer.MOSKIT_UNITY_LIB.MainCame"
				"ra\022\023\n\013fScaleRatio\030\004 \001(\002\022\016\n\006bVSync\030\005 \001(\010\022"
				"D\n\017Analysis_Buffer\030\006 \001(\0132+.MSAnalyzer.MO"
				"SKIT_UNITY_LIB.AnalysisBuffer\022@\n\017list_Co"
				"ntroller\030\007 \003(\0132\'.MSAnalyzer.MOSKIT_UNITY"
				"_LIB.Controller\022@\n\017list_gameObject\030\010 \003(\013"
				"2\'.MSAnalyzer.MOSKIT_UNITY_LIB.GameObjec"
				"t\"D\n\nArrayScene\0226\n\nlist_Scene\030\001 \003(\0132\".MS"
				"Analyzer.MOSKIT_UNITY_LIB.Scene\"\207\001\n\016Anal"
				"ysisBuffer\022\020\n\010list_Int\030\001 \003(\005\022\022\n\nlist_Flo"
				"at\030\002 \003(\002\022\023\n\013list_String\030\003 \003(\t\022:\n\014list_Ve"
				"ctor3\030\004 \003(\0132$.MSAnalyzer.MOSKIT_UNITY_LI"
				"B.Vector3", 1849);
...
#undef DO_
		...
		const int MainCamera::kFieldOfViewFieldNumber;
		const int MainCamera::kTransformFieldNumber;
		const int MainCamera::kHitpointFieldNumber;
		const int MainCamera::kFIPDFieldNumber;
		const int MainCamera::kListComponentFieldNumber;
#endif  // !defined(_MSC_VER) || _MSC_VER >= 1900
		...
		void MainCamera::SharedCtor() {
			...
			transform_ = NULL;
			hitpoint_ = NULL;
			::memset(&active_, 0, reinterpret_cast<char*>(&fipd_) -
				reinterpret_cast<char*>(&active_) + sizeof(fipd_));
		}
...
#define DO_(EXPRESSION) if (!GOOGLE_PREDICT_TRUE(EXPRESSION)) goto failure
			...
			for (;;) {
				...
				case 5: {
					...
					if (input->ExpectTag(53)) goto parse_FieldOfView;
					break;
				}
				...
				case 7: {
					...
					if (input->ExpectTag(66)) goto parse_hitpoint;
					break;
				}
				...
				case 8: {
					...
					if (input->ExpectTag(77)) goto parse_fIPD;
					break;
				}
				...
				case 9: {
					...
					if (input->ExpectTag(82)) goto parse_list_Component;
					break;
				}
				...
				case 10: {
					if (tag == 82) {
					parse_list_Component:
						DO_(input->IncrementRecursionDepth());
					parse_loop_list_Component:
						DO_(::google::protobuf::internal::WireFormatLite::ReadMessageNoVirtualNoRecursionDepth(
							input, add_list_component()));
					}
					else {
						goto handle_unusual;
					}
					if (input->ExpectTag(82)) goto parse_loop_list_Component;
...
#undef DO_
		...
		void MainCamera::SerializeWithCachedSizes(
			...
			// optional float FieldOfView = 6;
			if (has_fieldofview()) {
				::google::protobuf::internal::WireFormatLite::WriteFloat(6, this->fieldofview(), output);
			}
			...
			if (has_hitpoint()) {
				::google::protobuf::internal::WireFormatLite::WriteMessageMaybeToArray(
					8, *this->hitpoint_, output);
			}

			// optional float fIPD = 9;
			if (has_fipd()) {
				::google::protobuf::internal::WireFormatLite::WriteFloat(9, this->fipd(), output);
			}

			// repeated .MSAnalyzer.MOSKIT_UNITY_LIB.Component list_Component = 10;
			for (unsigned int i = 0, n = this->list_component_size(); i < n; i++) {
				::google::protobuf::internal::WireFormatLite::WriteMessageMaybeToArray(
					10, this->list_component(i), output);
			}
		...
		::google::protobuf::uint8* MainCamera::InternalSerializeWithCachedSizesToArray(
			...
			// optional float FieldOfView = 6;
			if (has_fieldofview()) {
				target = ::google::protobuf::internal::WireFormatLite::WriteFloatToArray(6, this->fieldofview(), target);
			}
			...
			if (has_hitpoint()) {
				target = ::google::protobuf::internal::WireFormatLite::
					InternalWriteMessageNoVirtualToArray(
						8, *this->hitpoint_, false, target);
			}

			// optional float fIPD = 9;
			if (has_fipd()) {
				target = ::google::protobuf::internal::WireFormatLite::WriteFloatToArray(9, this->fipd(), target);
			}
			...
			for (unsigned int i = 0, n = this->list_component_size(); i < n; i++) {
				target = ::google::protobuf::internal::WireFormatLite::
					InternalWriteMessageNoVirtualToArray(
						10, this->list_component(i), false, target);
			}
		...
		size_t MainCamera::ByteSizeLong() const {
			...
			// repeated .MSAnalyzer.MOSKIT_UNITY_LIB.Component list_Component = 10;
			{
				unsigned int count = this->list_component_size();
				total_size += 1UL * count;
				for (unsigned int i = 0; i < count; i++) {
					total_size +=
						::google::protobuf::internal::WireFormatLite::MessageSizeNoVirtual(
							this->list_component(i));
				}
			}
		...
		void MainCamera::UnsafeMergeFrom(const MainCamera& from) {
			GOOGLE_DCHECK(&from != this);
			list_component_.MergeFrom(from.list_component_);
			if (from._has_bits_[0 / 32] & (0xffu << (0 % 32))) {
				if (from.has_name()) {
					set_has_name();
		...
		void MainCamera::InternalSwap(MainCamera* other) {
			...
			std::swap(fipd_, other->fipd_);
			list_component_.UnsafeArenaSwap(&other->list_component_);
			std::swap(_has_bits_[0], other->_has_bits_[0]);
			_internal_metadata_.Swap(&other->_internal_metadata_);
			std::swap(_cached_size_, other->_cached_size_);
		}
		...
		// optional float FieldOfView = 6;
		bool MainCamera::has_fieldofview() const {
			return (_has_bits_[0] & 0x00000020u) != 0;
		}
		void MainCamera::set_has_fieldofview() {
			_has_bits_[0] |= 0x00000020u;
		}
		void MainCamera::clear_has_fieldofview() {
			_has_bits_[0] &= ~0x00000020u;
		}
		void MainCamera::clear_fieldofview() {
			fieldofview_ = 0;
			clear_has_fieldofview();
		}
		float MainCamera::fieldofview() const {
			// @@protoc_insertion_point(field_get:MSAnalyzer.MOSKIT_UNITY_LIB.MainCamera.FieldOfView)
			return fieldofview_;
		}
		void MainCamera::set_fieldofview(float value) {
			set_has_fieldofview();
			fieldofview_ = value;
		...
		// optional float fIPD = 9;
		bool MainCamera::has_fipd() const {
			return (_has_bits_[0] & 0x00000100u) != 0;
		}
		void MainCamera::set_has_fipd() {
			_has_bits_[0] |= 0x00000100u;
		}
		void MainCamera::clear_has_fipd() {
			_has_bits_[0] &= ~0x00000100u;
		}
		void MainCamera::clear_fipd() {
			fipd_ = 0;
			clear_has_fipd();
		}
		float MainCamera::fipd() const {
			// @@protoc_insertion_point(field_get:MSAnalyzer.MOSKIT_UNITY_LIB.MainCamera.fIPD)
			return fipd_;
		}
		void MainCamera::set_fipd(float value) {
			set_has_fipd();
			fipd_ = value;
		...
		// repeated .MSAnalyzer.MOSKIT_UNITY_LIB.Component list_Component = 10;
		int MainCamera::list_component_size() const {
			return list_component_.size();
		}
		void MainCamera::clear_list_component() {
			list_component_.Clear();
		}
		const ::MSAnalyzer::MOSKIT_UNITY_LIB::Component& MainCamera::list_component(int index) const {
			// @@protoc_insertion_point(field_get:MSAnalyzer.MOSKIT_UNITY_LIB.MainCamera.list_Component)
			return list_component_.Get(index);
		}
		::MSAnalyzer::MOSKIT_UNITY_LIB::Component* MainCamera::mutable_list_component(int index) {
		...
		::MSAnalyzer::MOSKIT_UNITY_LIB::Component* MainCamera::add_list_component() {
		...
		Component::Component()
			...
			if (this != internal_default_instance()) protobuf_InitDefaults_moskit_2eproto();
			SharedCtor();
			// @@protoc_insertion_point(constructor:MSAnalyzer.MOSKIT_UNITY_LIB.Component)
		}
		...
		Component::Component(const Component& from)
			...
			SharedCtor();
			UnsafeMergeFrom(from);
			// @@protoc_insertion_point(copy_constructor:MSAnalyzer.MOSKIT_UNITY_LIB.Component)
		}
		...
		Component::~Component() {
			// @@protoc_insertion_point(destructor:MSAnalyzer.MOSKIT_UNITY_LIB.Component)
			SharedDtor();
		}
		...
		void Component::Clear() {
			// @@protoc_insertion_point(message_clear_start:MSAnalyzer.MOSKIT_UNITY_LIB.Component)
			if (has_name()) {
				name_.ClearToEmptyNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
			}
			_has_bits_.Clear();
...
#define DO_(EXPRESSION) if (!GOOGLE_PREDICT_TRUE(EXPRESSION)) goto failure
			::google::protobuf::uint32 tag;
			// @@protoc_insertion_point(parse_start:MSAnalyzer.MOSKIT_UNITY_LIB.Component)
			for (;;) {
				::std::pair< ::google::protobuf::uint32, bool> p = input->ReadTagWithCutoff(127);
				tag = p.first;
				if (!p.second) goto handle_unusual;
				...
				case 1: {
					if (tag == 10) {
						...
						::google::protobuf::internal::WireFormat::VerifyUTF8StringNamedField(
							this->name().data(), this->name().length(),
							::google::protobuf::internal::WireFormat::PARSE,
							"MSAnalyzer.MOSKIT_UNITY_LIB.Component.name");
					}
					else {
						goto handle_unusual;
					}
		...
		success:
			// @@protoc_insertion_point(parse_success:MSAnalyzer.MOSKIT_UNITY_LIB.Component)
			return true;
		failure:
			// @@protoc_insertion_point(parse_failure:MSAnalyzer.MOSKIT_UNITY_LIB.Component)
			return false;
#undef DO_
		}
		...
		void Component::SerializeWithCachedSizes(
			::google::protobuf::io::CodedOutputStream* output) const {
			// @@protoc_insertion_point(serialize_start:MSAnalyzer.MOSKIT_UNITY_LIB.Component)
			// optional string name = 1;
			if (has_name()) {
				::google::protobuf::internal::WireFormat::VerifyUTF8StringNamedField(
					this->name().data(), this->name().length(),
			...
			// @@protoc_insertion_point(serialize_end:MSAnalyzer.MOSKIT_UNITY_LIB.Component)
		}

		::google::protobuf::uint8* Component::InternalSerializeWithCachedSizesToArray(
			bool deterministic, ::google::protobuf::uint8* target) const {
			(void)deterministic; // Unused
								 // @@protoc_insertion_point(serialize_to_array_start:MSAnalyzer.MOSKIT_UNITY_LIB.Component)
								 // optional string name = 1;
			if (has_name()) {
				::google::protobuf::internal::WireFormat::VerifyUTF8StringNamedField(
					this->name().data(), this->name().length(),
			...
			// @@protoc_insertion_point(serialize_to_array_end:MSAnalyzer.MOSKIT_UNITY_LIB.Component)
			return target;
		}

		size_t Component::ByteSizeLong() const {
			// @@protoc_insertion_point(message_byte_size_start:MSAnalyzer.MOSKIT_UNITY_LIB.Component)
			size_t total_size = 0;
		...
		void Component::MergeFrom(const ::google::protobuf::Message& from) {
			// @@protoc_insertion_point(generalized_merge_from_start:MSAnalyzer.MOSKIT_UNITY_LIB.Component)
			if (GOOGLE_PREDICT_FALSE(&from == this)) MergeFromFail(__LINE__);
			const Component* source =
				::google::protobuf::internal::DynamicCastToGenerated<const Component>(
					&from);
			if (source == NULL) {
				// @@protoc_insertion_point(generalized_merge_from_cast_fail:MSAnalyzer.MOSKIT_UNITY_LIB.Component)
				::google::protobuf::internal::ReflectionOps::Merge(from, this);
			}
			else {
				// @@protoc_insertion_point(generalized_merge_from_cast_success:MSAnalyzer.MOSKIT_UNITY_LIB.Component)
				UnsafeMergeFrom(*source);
			}
		}

		void Component::MergeFrom(const Component& from) {
			// @@protoc_insertion_point(class_specific_merge_from_start:MSAnalyzer.MOSKIT_UNITY_LIB.Component)
			if (GOOGLE_PREDICT_TRUE(&from != this)) {
				UnsafeMergeFrom(from);
			}
			else {
		...
		void Component::CopyFrom(const ::google::protobuf::Message& from) {
			// @@protoc_insertion_point(generalized_copy_from_start:MSAnalyzer.MOSKIT_UNITY_LIB.Component)
			if (&from == this) return;
			Clear();
			MergeFrom(from);
		}
		...
		void Component::CopyFrom(const Component& from) {
			// @@protoc_insertion_point(class_specific_copy_from_start:MSAnalyzer.MOSKIT_UNITY_LIB.Component)
			if (&from == this) return;
			Clear();
			UnsafeMergeFrom(from);
		}
...
#if !defined(_MSC_VER) || _MSC_VER >= 1900
		const int Controller::kNameFieldNumber;
		const int Controller::kActiveFieldNumber;
		const int Controller::kLayerFieldNumber;
		const int Controller::kInstanceIDFieldNumber;
		const int Controller::kTagFieldNumber;
		const int Controller::kTransformFieldNumber;
		const int Controller::kListComponentFieldNumber;
#endif  // !defined(_MSC_VER) || _MSC_VER >= 1900
		...
		Controller::Controller()
			...
			if (this != internal_default_instance()) protobuf_InitDefaults_moskit_2eproto();
			SharedCtor();
			// @@protoc_insertion_point(constructor:MSAnalyzer.MOSKIT_UNITY_LIB.Controller)
		}
		...
		Controller::Controller(const Controller& from)
			...
			SharedCtor();
			UnsafeMergeFrom(from);
			// @@protoc_insertion_point(copy_constructor:MSAnalyzer.MOSKIT_UNITY_LIB.Controller)
		}
		...
		Controller::~Controller() {
			// @@protoc_insertion_point(destructor:MSAnalyzer.MOSKIT_UNITY_LIB.Controller)
			SharedDtor();
		}
		...
		void Controller::SharedDtor() {
			name_.DestroyNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
			tag_.DestroyNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
			if (this != &Controller_default_instance_.get()) {
				delete transform_;
			}
		}
		...
		::google::protobuf::internal::ExplicitlyConstructed<Controller> Controller_default_instance_;
		...
		void Controller::Clear() {
			// @@protoc_insertion_point(message_clear_start:MSAnalyzer.MOSKIT_UNITY_LIB.Controller)
#if defined(__clang__)
#define ZR_HELPER_(f) \
  _Pragma("clang diagnostic push") \
  _Pragma("clang diagnostic ignored \"-Winvalid-offsetof\"") \
  __builtin_offsetof(Controller, f) \
  _Pragma("clang diagnostic pop")
#else
#define ZR_HELPER_(f) reinterpret_cast<char*>(\
  &reinterpret_cast<Controller*>(16)->f)
#endif
...
#define DO_(EXPRESSION) if (!GOOGLE_PREDICT_TRUE(EXPRESSION)) goto failure
			::google::protobuf::uint32 tag;
			// @@protoc_insertion_point(parse_start:MSAnalyzer.MOSKIT_UNITY_LIB.Controller)
			for (;;) {
				::std::pair< ::google::protobuf::uint32, bool> p = input->ReadTagWithCutoff(127);
				tag = p.first;
				if (!p.second) goto handle_unusual;
				...
				case 1: {
					if (tag == 10) {
						...
						::google::protobuf::internal::WireFormat::VerifyUTF8StringNamedField(
							this->name().data(), this->name().length(),
							::google::protobuf::internal::WireFormat::PARSE,
							"MSAnalyzer.MOSKIT_UNITY_LIB.Controller.name");
					}
					else {
						goto handle_unusual;
					}
				...
				case 5: {
					...
					parse_tag:
						...
						::google::protobuf::internal::WireFormat::VerifyUTF8StringNamedField(
							this->tag().data(), this->tag().length(),
							::google::protobuf::internal::WireFormat::PARSE,
							"MSAnalyzer.MOSKIT_UNITY_LIB.Controller.tag");
					}
					else {
						goto handle_unusual;
					}
				...
				case 6: {
					...
					if (input->ExpectTag(58)) goto parse_list_Component;
					break;
				}
				...
				case 7: {
					...
					if (input->ExpectTag(58)) goto parse_loop_list_Component;
					input->UnsafeDecrementRecursionDepth();
					if (input->ExpectAtEnd()) goto success;
					break;
				}
		...
		success:
			// @@protoc_insertion_point(parse_success:MSAnalyzer.MOSKIT_UNITY_LIB.Controller)
			return true;
		failure:
			// @@protoc_insertion_point(parse_failure:MSAnalyzer.MOSKIT_UNITY_LIB.Controller)
			return false;
#undef DO_
		}
		...
		void Controller::SerializeWithCachedSizes(
			::google::protobuf::io::CodedOutputStream* output) const {
			// @@protoc_insertion_point(serialize_start:MSAnalyzer.MOSKIT_UNITY_LIB.Controller)
			// optional string name = 1;
			if (has_name()) {
				::google::protobuf::internal::WireFormat::VerifyUTF8StringNamedField(
					this->name().data(), this->name().length(),
			...
			for (unsigned int i = 0, n = this->list_component_size(); i < n; i++) {
				::google::protobuf::internal::WireFormatLite::WriteMessageMaybeToArray(
					7, this->list_component(i), output);
			}
			...
			// @@protoc_insertion_point(serialize_end:MSAnalyzer.MOSKIT_UNITY_LIB.Controller)
		}

		::google::protobuf::uint8* Controller::InternalSerializeWithCachedSizesToArray(
			bool deterministic, ::google::protobuf::uint8* target) const {
			(void)deterministic; // Unused
								 // @@protoc_insertion_point(serialize_to_array_start:MSAnalyzer.MOSKIT_UNITY_LIB.Controller)
								 // optional string name = 1;
			if (has_name()) {
				::google::protobuf::internal::WireFormat::VerifyUTF8StringNamedField(
					this->name().data(), this->name().length(),
			...
			for (unsigned int i = 0, n = this->list_component_size(); i < n; i++) {
				target = ::google::protobuf::internal::WireFormatLite::
					InternalWriteMessageNoVirtualToArray(
						7, this->list_component(i), false, target);
			}
			...
			// @@protoc_insertion_point(serialize_to_array_end:MSAnalyzer.MOSKIT_UNITY_LIB.Controller)
			return target;
		}

		size_t Controller::ByteSizeLong() const {
			// @@protoc_insertion_point(message_byte_size_start:MSAnalyzer.MOSKIT_UNITY_LIB.Controller)
			size_t total_size = 0;
		...
		void Controller::MergeFrom(const ::google::protobuf::Message& from) {
			// @@protoc_insertion_point(generalized_merge_from_start:MSAnalyzer.MOSKIT_UNITY_LIB.Controller)
			if (GOOGLE_PREDICT_FALSE(&from == this)) MergeFromFail(__LINE__);
			const Controller* source =
				::google::protobuf::internal::DynamicCastToGenerated<const Controller>(
					&from);
			if (source == NULL) {
				// @@protoc_insertion_point(generalized_merge_from_cast_fail:MSAnalyzer.MOSKIT_UNITY_LIB.Controller)
				::google::protobuf::internal::ReflectionOps::Merge(from, this);
			}
			else {
				// @@protoc_insertion_point(generalized_merge_from_cast_success:MSAnalyzer.MOSKIT_UNITY_LIB.Controller)
				UnsafeMergeFrom(*source);
			}
		}

		void Controller::MergeFrom(const Controller& from) {
			// @@protoc_insertion_point(class_specific_merge_from_start:MSAnalyzer.MOSKIT_UNITY_LIB.Controller)
			if (GOOGLE_PREDICT_TRUE(&from != this)) {
				UnsafeMergeFrom(from);
			}
			else {
		...
		void Controller::UnsafeMergeFrom(const Controller& from) {
			GOOGLE_DCHECK(&from != this);
			list_component_.MergeFrom(from.list_component_);
			if (from._has_bits_[0 / 32] & (0xffu << (0 % 32))) {
				if (from.has_name()) {
		...
		void Controller::CopyFrom(const ::google::protobuf::Message& from) {
			// @@protoc_insertion_point(generalized_copy_from_start:MSAnalyzer.MOSKIT_UNITY_LIB.Controller)
			if (&from == this) return;
			Clear();
			MergeFrom(from);
		}
		...
		void Controller::CopyFrom(const Controller& from) {
			// @@protoc_insertion_point(class_specific_copy_from_start:MSAnalyzer.MOSKIT_UNITY_LIB.Controller)
			if (&from == this) return;
			Clear();
			UnsafeMergeFrom(from);
		}
		...
		// optional string name = 1;
		bool Controller::has_name() const {
			return (_has_bits_[0] & 0x00000001u) != 0;
		}
		void Controller::set_has_name() {
			_has_bits_[0] |= 0x00000001u;
		}
		void Controller::clear_has_name() {
			_has_bits_[0] &= ~0x00000001u;
		}
		void Controller::clear_name() {
			name_.ClearToEmptyNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
			clear_has_name();
		}
		...
		// optional bool active = 2;
		bool Controller::has_active() const {
			return (_has_bits_[0] & 0x00000002u) != 0;
		}
		void Controller::set_has_active() {
			_has_bits_[0] |= 0x00000002u;
		}
		void Controller::clear_has_active() {
			_has_bits_[0] &= ~0x00000002u;
		}
		void Controller::clear_active() {
			active_ = false;
			clear_has_active();
		}
		...
		void Controller::set_active(bool value) {
			set_has_active();
			active_ = value;
		...
		// optional int32 layer = 3;
		bool Controller::has_layer() const {
			return (_has_bits_[0] & 0x00000004u) != 0;
		}
		void Controller::set_has_layer() {
			_has_bits_[0] |= 0x00000004u;
		}
		void Controller::clear_has_layer() {
			_has_bits_[0] &= ~0x00000004u;
		}
		void Controller::clear_layer() {
			layer_ = 0;
			clear_has_layer();
		}
		::google::protobuf::int32 Controller::layer() const {
			// @@protoc_insertion_point(field_get:MSAnalyzer.MOSKIT_UNITY_LIB.Controller.layer)
			return layer_;
		}
		void Controller::set_layer(::google::protobuf::int32 value) {
			set_has_layer();
			layer_ = value;
		...
		// optional int32 instanceID = 4;
		bool Controller::has_instanceid() const {
			return (_has_bits_[0] & 0x00000008u) != 0;
		}
		void Controller::set_has_instanceid() {
			_has_bits_[0] |= 0x00000008u;
		}
		void Controller::clear_has_instanceid() {
			_has_bits_[0] &= ~0x00000008u;
		}
		void Controller::clear_instanceid() {
			instanceid_ = 0;
			clear_has_instanceid();
		}
		::google::protobuf::int32 Controller::instanceid() const {
			// @@protoc_insertion_point(field_get:MSAnalyzer.MOSKIT_UNITY_LIB.Controller.instanceID)
			return instanceid_;
		}
		void Controller::set_instanceid(::google::protobuf::int32 value) {
			set_has_instanceid();
			instanceid_ = value;
		...
		// optional .MSAnalyzer.MOSKIT_UNITY_LIB.Transform transform = 6;
		bool Controller::has_transform() const {
			return (_has_bits_[0] & 0x00000020u) != 0;
		}
		void Controller::set_has_transform() {
			_has_bits_[0] |= 0x00000020u;
		}
		void Controller::clear_has_transform() {
			_has_bits_[0] &= ~0x00000020u;
		}
		void Controller::clear_transform() {
			if (transform_ != NULL) transform_->::MSAnalyzer::MOSKIT_UNITY_LIB::Transform::Clear();
			clear_has_transform();
		}
		const ::MSAnalyzer::MOSKIT_UNITY_LIB::Transform& Controller::transform() const {
			// @@protoc_insertion_point(field_get:MSAnalyzer.MOSKIT_UNITY_LIB.Controller.transform)
			return transform_ != NULL ? *transform_
				: *::MSAnalyzer::MOSKIT_UNITY_LIB::Transform::internal_default_instance();
		}
		::MSAnalyzer::MOSKIT_UNITY_LIB::Transform* Controller::mutable_transform() {
			set_has_transform();
			if (transform_ == NULL) {
				transform_ = new ::MSAnalyzer::MOSKIT_UNITY_LIB::Transform;
			}
		...
		::MSAnalyzer::MOSKIT_UNITY_LIB::Transform* Controller::release_transform() {
		...
		void Controller::set_allocated_transform(::MSAnalyzer::MOSKIT_UNITY_LIB::Transform* transform) {
			delete transform_;
			transform_ = transform;
			if (transform) {
				set_has_transform();
		...
		// repeated .MSAnalyzer.MOSKIT_UNITY_LIB.Component list_Component = 7;
		int Controller::list_component_size() const {
			return list_component_.size();
		}
		void Controller::clear_list_component() {
			list_component_.Clear();
		}
		const ::MSAnalyzer::MOSKIT_UNITY_LIB::Component& Controller::list_component(int index) const {
			// @@protoc_insertion_point(field_get:MSAnalyzer.MOSKIT_UNITY_LIB.Controller.list_Component)
			return list_component_.Get(index);
		}
		::MSAnalyzer::MOSKIT_UNITY_LIB::Component* Controller::mutable_list_component(int index) {
			// @@protoc_insertion_point(field_mutable:MSAnalyzer.MOSKIT_UNITY_LIB.Controller.list_Component)
			return list_component_.Mutable(index);
		}
		::MSAnalyzer::MOSKIT_UNITY_LIB::Component* Controller::add_list_component() {
...
#undef DO_
		...
		const int GameObject::kListComponentFieldNumber;
#endif  // !defined(_MSC_VER) || _MSC_VER >= 1900
...
#define DO_(EXPRESSION) if (!GOOGLE_PREDICT_TRUE(EXPRESSION)) goto failure
			...
			for (;;) {
				...
				case 8: {
					...
					if (input->ExpectTag(74)) goto parse_list_Component;
					break;
				}
				...
				case 9: {
					...
					if (input->ExpectTag(74)) goto parse_loop_list_Component;
					input->UnsafeDecrementRecursionDepth();
					if (input->ExpectAtEnd()) goto success;
					break;
				}
...
#undef DO_
		...
		void GameObject::SerializeWithCachedSizes(
			...
			for (unsigned int i = 0, n = this->list_component_size(); i < n; i++) {
				::google::protobuf::internal::WireFormatLite::WriteMessageMaybeToArray(
					9, this->list_component(i), output);
			}
		...
		::google::protobuf::uint8* GameObject::InternalSerializeWithCachedSizesToArray(
			...
			for (unsigned int i = 0, n = this->list_component_size(); i < n; i++) {
				target = ::google::protobuf::internal::WireFormatLite::
					InternalWriteMessageNoVirtualToArray(
						9, this->list_component(i), false, target);
			}
		...
		// repeated .MSAnalyzer.MOSKIT_UNITY_LIB.Component list_Component = 9;
		int GameObject::list_component_size() const {
			return list_component_.size();
		}
		void GameObject::clear_list_component() {
			list_component_.Clear();
		}
		const ::MSAnalyzer::MOSKIT_UNITY_LIB::Component& GameObject::list_component(int index) const {
			// @@protoc_insertion_point(field_get:MSAnalyzer.MOSKIT_UNITY_LIB.GameObject.list_Component)
			return list_component_.Get(index);
		}
		::MSAnalyzer::MOSKIT_UNITY_LIB::Component* GameObject::mutable_list_component(int index) {
			// @@protoc_insertion_point(field_mutable:MSAnalyzer.MOSKIT_UNITY_LIB.GameObject.list_Component)
			return list_component_.Mutable(index);
		}
		::MSAnalyzer::MOSKIT_UNITY_LIB::Component* GameObject::add_list_component() {
		...
		const int Scene::kFScaleRatioFieldNumber;
		const int Scene::kBVSyncFieldNumber;
		const int Scene::kAnalysisBufferFieldNumber;
		const int Scene::kListControllerFieldNumber;
		...
		void Scene::InitAsDefaultInstance() {
			...
			analysis_buffer_ = const_cast< ::MSAnalyzer::MOSKIT_UNITY_LIB::AnalysisBuffer*>(
		...
		void Scene::SharedCtor() {
			...
			::memset(&fscaleratio_, 0, reinterpret_cast<char*>(&bvsync_) -
				reinterpret_cast<char*>(&fscaleratio_) + sizeof(bvsync_));
		}
...
#define DO_(EXPRESSION) if (!GOOGLE_PREDICT_TRUE(EXPRESSION)) goto failure
			...
			for (;;) {
				...
				case 3: {
					...
					if (input->ExpectTag(37)) goto parse_fScaleRatio;
					break;
				}
				...
				case 4: {
					...
					if (input->ExpectTag(40)) goto parse_bVSync;
					break;
				}
				...
				case 5: {
					...
					if (input->ExpectTag(50)) goto parse_Analysis_Buffer;
					break;
				}
				...
				case 6: {
					if (tag == 50) {
					parse_Analysis_Buffer:
						DO_(::google::protobuf::internal::WireFormatLite::ReadMessageNoVirtual(
							input, mutable_analysis_buffer()));
					}
					else {
						goto handle_unusual;
					}
					if (input->ExpectTag(58)) goto parse_list_Controller;
					break;
				}
				...
				case 7: {
					if (tag == 58) {
					parse_list_Controller:
						DO_(input->IncrementRecursionDepth());
					parse_loop_list_Controller:
						DO_(::google::protobuf::internal::WireFormatLite::ReadMessageNoVirtualNoRecursionDepth(
							input, add_list_controller()));
					}
					else {
						goto handle_unusual;
					}
					if (input->ExpectTag(58)) goto parse_loop_list_Controller;
					if (input->ExpectTag(66)) goto parse_loop_list_gameObject;
					input->UnsafeDecrementRecursionDepth();
					break;
				}
...
#undef DO_
		...
		void Scene::SerializeWithCachedSizes(
			...
			// optional float fScaleRatio = 4;
			if (has_fscaleratio()) {
				::google::protobuf::internal::WireFormatLite::WriteFloat(4, this->fscaleratio(), output);
			}

			// optional bool bVSync = 5;
			if (has_bvsync()) {
				::google::protobuf::internal::WireFormatLite::WriteBool(5, this->bvsync(), output);
			}

			// optional .MSAnalyzer.MOSKIT_UNITY_LIB.AnalysisBuffer Analysis_Buffer = 6;
			if (has_analysis_buffer()) {
				::google::protobuf::internal::WireFormatLite::WriteMessageMaybeToArray(
					6, *this->analysis_buffer_, output);
			}

			// repeated .MSAnalyzer.MOSKIT_UNITY_LIB.Controller list_Controller = 7;
			for (unsigned int i = 0, n = this->list_controller_size(); i < n; i++) {
				::google::protobuf::internal::WireFormatLite::WriteMessageMaybeToArray(
					7, this->list_controller(i), output);
			}

			// repeated .MSAnalyzer.MOSKIT_UNITY_LIB.GameObject list_gameObject = 8;
			for (unsigned int i = 0, n = this->list_gameobject_size(); i < n; i++) {
				::google::protobuf::internal::WireFormatLite::WriteMessageMaybeToArray(
					8, this->list_gameobject(i), output);
			}
		...
		::google::protobuf::uint8* Scene::InternalSerializeWithCachedSizesToArray(
			...
			// optional float fScaleRatio = 4;
			if (has_fscaleratio()) {
				target = ::google::protobuf::internal::WireFormatLite::WriteFloatToArray(4, this->fscaleratio(), target);
			}

			// optional bool bVSync = 5;
			if (has_bvsync()) {
				target = ::google::protobuf::internal::WireFormatLite::WriteBoolToArray(5, this->bvsync(), target);
			}
			...
			if (has_analysis_buffer()) {
				target = ::google::protobuf::internal::WireFormatLite::
					InternalWriteMessageNoVirtualToArray(
						6, *this->analysis_buffer_, false, target);
			}
			...
			for (unsigned int i = 0, n = this->list_controller_size(); i < n; i++) {
				target = ::google::protobuf::internal::WireFormatLite::
					InternalWriteMessageNoVirtualToArray(
						7, this->list_controller(i), false, target);
			}
			...
			for (unsigned int i = 0, n = this->list_gameobject_size(); i < n; i++) {
				target = ::google::protobuf::internal::WireFormatLite::
					InternalWriteMessageNoVirtualToArray(
						8, this->list_gameobject(i), false, target);
			}
		...
		size_t Scene::ByteSizeLong() const {
			...
			if (_has_bits_[0 / 32] & 63u) {
				...
				if (has_analysis_buffer()) {
					total_size += 1 +
						::google::protobuf::internal::WireFormatLite::MessageSizeNoVirtual(
							*this->analysis_buffer_);
				}

			}
			// repeated .MSAnalyzer.MOSKIT_UNITY_LIB.Controller list_Controller = 7;
			{
				unsigned int count = this->list_controller_size();
				total_size += 1UL * count;
				for (unsigned int i = 0; i < count; i++) {
					total_size +=
						::google::protobuf::internal::WireFormatLite::MessageSizeNoVirtual(
							this->list_controller(i));
				}
			}
		...
		void Scene::UnsafeMergeFrom(const Scene& from) {
			GOOGLE_DCHECK(&from != this);
			list_controller_.MergeFrom(from.list_controller_);
			...
			if (from._has_bits_[0 / 32] & (0xffu << (0 % 32))) {
				...
				if (from.has_fscaleratio()) {
					set_fscaleratio(from.fscaleratio());
				}
				if (from.has_bvsync()) {
					set_bvsync(from.bvsync());
				}
				if (from.has_analysis_buffer()) {
					mutable_analysis_buffer()->::MSAnalyzer::MOSKIT_UNITY_LIB::AnalysisBuffer::MergeFrom(from.analysis_buffer());
				}
			}
			if (from._internal_metadata_.have_unknown_fields()) {
				::google::protobuf::UnknownFieldSet::MergeToInternalMetdata(
		...
		void Scene::InternalSwap(Scene* other) {
			...
			std::swap(fscaleratio_, other->fscaleratio_);
			std::swap(bvsync_, other->bvsync_);
			std::swap(analysis_buffer_, other->analysis_buffer_);
			list_controller_.UnsafeArenaSwap(&other->list_controller_);
		...
		// optional float fScaleRatio = 4;
		bool Scene::has_fscaleratio() const {
			return (_has_bits_[0] & 0x00000008u) != 0;
		}
		void Scene::set_has_fscaleratio() {
			_has_bits_[0] |= 0x00000008u;
		}
		void Scene::clear_has_fscaleratio() {
			_has_bits_[0] &= ~0x00000008u;
		}
		void Scene::clear_fscaleratio() {
			fscaleratio_ = 0;
			clear_has_fscaleratio();
		}
		float Scene::fscaleratio() const {
			// @@protoc_insertion_point(field_get:MSAnalyzer.MOSKIT_UNITY_LIB.Scene.fScaleRatio)
			return fscaleratio_;
		}
		void Scene::set_fscaleratio(float value) {
			set_has_fscaleratio();
			fscaleratio_ = value;
		...
		// optional bool bVSync = 5;
		bool Scene::has_bvsync() const {
			return (_has_bits_[0] & 0x00000010u) != 0;
		}
		void Scene::set_has_bvsync() {
			_has_bits_[0] |= 0x00000010u;
		}
		void Scene::clear_has_bvsync() {
			_has_bits_[0] &= ~0x00000010u;
		}
		void Scene::clear_bvsync() {
			bvsync_ = false;
			clear_has_bvsync();
		}
		bool Scene::bvsync() const {
			// @@protoc_insertion_point(field_get:MSAnalyzer.MOSKIT_UNITY_LIB.Scene.bVSync)
			return bvsync_;
		}
		void Scene::set_bvsync(bool value) {
			set_has_bvsync();
			bvsync_ = value;
		...
		// optional .MSAnalyzer.MOSKIT_UNITY_LIB.AnalysisBuffer Analysis_Buffer = 6;
		bool Scene::has_analysis_buffer() const {
			return (_has_bits_[0] & 0x00000020u) != 0;
		}
		void Scene::set_has_analysis_buffer() {
			_has_bits_[0] |= 0x00000020u;
		}
		void Scene::clear_has_analysis_buffer() {
			_has_bits_[0] &= ~0x00000020u;
		}
		void Scene::clear_analysis_buffer() {
			if (analysis_buffer_ != NULL) analysis_buffer_->::MSAnalyzer::MOSKIT_UNITY_LIB::AnalysisBuffer::Clear();
			clear_has_analysis_buffer();
		}
		const ::MSAnalyzer::MOSKIT_UNITY_LIB::AnalysisBuffer& Scene::analysis_buffer() const {
		...
		::MSAnalyzer::MOSKIT_UNITY_LIB::AnalysisBuffer* Scene::mutable_analysis_buffer() {
		...
		::MSAnalyzer::MOSKIT_UNITY_LIB::AnalysisBuffer* Scene::release_analysis_buffer() {
		...
		void Scene::set_allocated_analysis_buffer(::MSAnalyzer::MOSKIT_UNITY_LIB::AnalysisBuffer* analysis_buffer) {
			delete analysis_buffer_;
		...
		// repeated .MSAnalyzer.MOSKIT_UNITY_LIB.Controller list_Controller = 7;
		int Scene::list_controller_size() const {
			return list_controller_.size();
		}
		void Scene::clear_list_controller() {
			list_controller_.Clear();
		}
		const ::MSAnalyzer::MOSKIT_UNITY_LIB::Controller& Scene::list_controller(int index) const {
			// @@protoc_insertion_point(field_get:MSAnalyzer.MOSKIT_UNITY_LIB.Scene.list_Controller)
			return list_controller_.Get(index);
		}
		::MSAnalyzer::MOSKIT_UNITY_LIB::Controller* Scene::mutable_list_controller(int index) {
		...
		::MSAnalyzer::MOSKIT_UNITY_LIB::Controller* Scene::add_list_controller() {
...
#undef DO_
...
#if !defined(_MSC_VER) || _MSC_VER >= 1900
		const int AnalysisBuffer::kListIntFieldNumber;
		const int AnalysisBuffer::kListFloatFieldNumber;
		const int AnalysisBuffer::kListStringFieldNumber;
		const int AnalysisBuffer::kListVector3FieldNumber;
#endif  // !defined(_MSC_VER) || _MSC_VER >= 1900
		...
		AnalysisBuffer::AnalysisBuffer()
			...
			if (this != internal_default_instance()) protobuf_InitDefaults_moskit_2eproto();
			SharedCtor();
			// @@protoc_insertion_point(constructor:MSAnalyzer.MOSKIT_UNITY_LIB.AnalysisBuffer)
		}

		void AnalysisBuffer::InitAsDefaultInstance() {
		}

		AnalysisBuffer::AnalysisBuffer(const AnalysisBuffer& from)
			: ::google::protobuf::Message(),
			_internal_metadata_(NULL) {
			SharedCtor();
			UnsafeMergeFrom(from);
			// @@protoc_insertion_point(copy_constructor:MSAnalyzer.MOSKIT_UNITY_LIB.AnalysisBuffer)
		}

		void AnalysisBuffer::SharedCtor() {
			_cached_size_ = 0;
		}

		AnalysisBuffer::~AnalysisBuffer() {
			// @@protoc_insertion_point(destructor:MSAnalyzer.MOSKIT_UNITY_LIB.AnalysisBuffer)
			SharedDtor();
		}

		void AnalysisBuffer::SharedDtor() {
		}

		void AnalysisBuffer::SetCachedSize(int size) const {
			GOOGLE_SAFE_CONCURRENT_WRITES_BEGIN();
			_cached_size_ = size;
			GOOGLE_SAFE_CONCURRENT_WRITES_END();
		}
		const ::google::protobuf::Descriptor* AnalysisBuffer::descriptor() {
			protobuf_AssignDescriptorsOnce();
			return AnalysisBuffer_descriptor_;
		}

		const AnalysisBuffer& AnalysisBuffer::default_instance() {
			protobuf_InitDefaults_moskit_2eproto();
			return *internal_default_instance();
		}

		::google::protobuf::internal::ExplicitlyConstructed<AnalysisBuffer> AnalysisBuffer_default_instance_;

		AnalysisBuffer* AnalysisBuffer::New(::google::protobuf::Arena* arena) const {
			AnalysisBuffer* n = new AnalysisBuffer;
			if (arena != NULL) {
				arena->Own(n);
			}
			return n;
		...
		void AnalysisBuffer::Clear() {
			// @@protoc_insertion_point(message_clear_start:MSAnalyzer.MOSKIT_UNITY_LIB.AnalysisBuffer)
			list_int_.Clear();
			list_float_.Clear();
			list_string_.Clear();
			list_vector3_.Clear();
		...
		bool AnalysisBuffer::MergePartialFromCodedStream(
			::google::protobuf::io::CodedInputStream* input) {
#define DO_(EXPRESSION) if (!GOOGLE_PREDICT_TRUE(EXPRESSION)) goto failure
			::google::protobuf::uint32 tag;
			// @@protoc_insertion_point(parse_start:MSAnalyzer.MOSKIT_UNITY_LIB.AnalysisBuffer)
			for (;;) {
				::std::pair< ::google::protobuf::uint32, bool> p = input->ReadTagWithCutoff(127);
				tag = p.first;
				if (!p.second) goto handle_unusual;
				...
				case 1: {
					...
					parse_list_Int:
						DO_((::google::protobuf::internal::WireFormatLite::ReadRepeatedPrimitive<
							::google::protobuf::int32, ::google::protobuf::internal::WireFormatLite::TYPE_INT32>(
								1, 8, input, this->mutable_list_int())));
					}
					else if (tag == 10) {
						DO_((::google::protobuf::internal::WireFormatLite::ReadPackedPrimitiveNoInline<
							::google::protobuf::int32, ::google::protobuf::internal::WireFormatLite::TYPE_INT32>(
								input, this->mutable_list_int())));
					}
					else {
						goto handle_unusual;
					}
					if (input->ExpectTag(8)) goto parse_list_Int;
					if (input->ExpectTag(21)) goto parse_list_Float;
					break;
				}
				...
				case 2: {
					...
					parse_list_Float:
						DO_((::google::protobuf::internal::WireFormatLite::ReadRepeatedPrimitive<
							float, ::google::protobuf::internal::WireFormatLite::TYPE_FLOAT>(
								1, 21, input, this->mutable_list_float())));
					}
					else if (tag == 18) {
						DO_((::google::protobuf::internal::WireFormatLite::ReadPackedPrimitiveNoInline<
							float, ::google::protobuf::internal::WireFormatLite::TYPE_FLOAT>(
								input, this->mutable_list_float())));
					}
					else {
						goto handle_unusual;
					}
					if (input->ExpectTag(21)) goto parse_list_Float;
					if (input->ExpectTag(26)) goto parse_list_String;
					break;
				}
				...
				case 3: {
					...
					parse_list_String:
						DO_(::google::protobuf::internal::WireFormatLite::ReadString(
							input, this->add_list_string()));
						::google::protobuf::internal::WireFormat::VerifyUTF8StringNamedField(
							this->list_string(this->list_string_size() - 1).data(),
							this->list_string(this->list_string_size() - 1).length(),
							::google::protobuf::internal::WireFormat::PARSE,
							"MSAnalyzer.MOSKIT_UNITY_LIB.AnalysisBuffer.list_String");
					}
					else {
						goto handle_unusual;
					}
					if (input->ExpectTag(26)) goto parse_list_String;
					if (input->ExpectTag(34)) goto parse_list_Vector3;
					break;
				}
				...
				case 4: {
					...
					parse_list_Vector3:
						DO_(input->IncrementRecursionDepth());
					parse_loop_list_Vector3:
						DO_(::google::protobuf::internal::WireFormatLite::ReadMessageNoVirtualNoRecursionDepth(
							input, add_list_vector3()));
					}
					else {
						goto handle_unusual;
					}
					if (input->ExpectTag(34)) goto parse_loop_list_Vector3;
					input->UnsafeDecrementRecursionDepth();
					if (input->ExpectAtEnd()) goto success;
					break;
				}
		...
		success:
			// @@protoc_insertion_point(parse_success:MSAnalyzer.MOSKIT_UNITY_LIB.AnalysisBuffer)
			return true;
		failure:
			// @@protoc_insertion_point(parse_failure:MSAnalyzer.MOSKIT_UNITY_LIB.AnalysisBuffer)
			return false;
#undef DO_
		}

		void AnalysisBuffer::SerializeWithCachedSizes(
			::google::protobuf::io::CodedOutputStream* output) const {
			// @@protoc_insertion_point(serialize_start:MSAnalyzer.MOSKIT_UNITY_LIB.AnalysisBuffer)
			// repeated int32 list_Int = 1;
			for (int i = 0; i < this->list_int_size(); i++) {
				::google::protobuf::internal::WireFormatLite::WriteInt32(
					1, this->list_int(i), output);
			}

			// repeated float list_Float = 2;
			for (int i = 0; i < this->list_float_size(); i++) {
				::google::protobuf::internal::WireFormatLite::WriteFloat(
					2, this->list_float(i), output);
			}

			// repeated string list_String = 3;
			for (int i = 0; i < this->list_string_size(); i++) {
				::google::protobuf::internal::WireFormat::VerifyUTF8StringNamedField(
					this->list_string(i).data(), this->list_string(i).length(),
					::google::protobuf::internal::WireFormat::SERIALIZE,
					"MSAnalyzer.MOSKIT_UNITY_LIB.AnalysisBuffer.list_String");
				::google::protobuf::internal::WireFormatLite::WriteString(
					3, this->list_string(i), output);
			}

			// repeated .MSAnalyzer.MOSKIT_UNITY_LIB.Vector3 list_Vector3 = 4;
			for (unsigned int i = 0, n = this->list_vector3_size(); i < n; i++) {
				::google::protobuf::internal::WireFormatLite::WriteMessageMaybeToArray(
					4, this->list_vector3(i), output);
			}
			...
			// @@protoc_insertion_point(serialize_end:MSAnalyzer.MOSKIT_UNITY_LIB.AnalysisBuffer)
		}

		::google::protobuf::uint8* AnalysisBuffer::InternalSerializeWithCachedSizesToArray(
			bool deterministic, ::google::protobuf::uint8* target) const {
			(void)deterministic; // Unused
								 // @@protoc_insertion_point(serialize_to_array_start:MSAnalyzer.MOSKIT_UNITY_LIB.AnalysisBuffer)
								 // repeated int32 list_Int = 1;
			for (int i = 0; i < this->list_int_size(); i++) {
				target = ::google::protobuf::internal::WireFormatLite::
					WriteInt32ToArray(1, this->list_int(i), target);
			}

			// repeated float list_Float = 2;
			for (int i = 0; i < this->list_float_size(); i++) {
				target = ::google::protobuf::internal::WireFormatLite::
					WriteFloatToArray(2, this->list_float(i), target);
			}
			...
			for (int i = 0; i < this->list_string_size(); i++) {
				::google::protobuf::internal::WireFormat::VerifyUTF8StringNamedField(
					...
					"MSAnalyzer.MOSKIT_UNITY_LIB.AnalysisBuffer.list_String");
				target = ::google::protobuf::internal::WireFormatLite::
					WriteStringToArray(3, this->list_string(i), target);
			}
			...
			for (unsigned int i = 0, n = this->list_vector3_size(); i < n; i++) {
				target = ::google::protobuf::internal::WireFormatLite::
					InternalWriteMessageNoVirtualToArray(
						4, this->list_vector3(i), false, target);
			}
			...
			// @@protoc_insertion_point(serialize_to_array_end:MSAnalyzer.MOSKIT_UNITY_LIB.AnalysisBuffer)
			return target;
		}

		size_t AnalysisBuffer::ByteSizeLong() const {
			// @@protoc_insertion_point(message_byte_size_start:MSAnalyzer.MOSKIT_UNITY_LIB.AnalysisBuffer)
			size_t total_size = 0;

			// repeated int32 list_Int = 1;
			{
				size_t data_size = 0;
				unsigned int count = this->list_int_size();
				for (unsigned int i = 0; i < count; i++) {
					data_size += ::google::protobuf::internal::WireFormatLite::
						Int32Size(this->list_int(i));
				}
				total_size += 1 *
					::google::protobuf::internal::FromIntSize(this->list_int_size());
			...
			{
				size_t data_size = 0;
				unsigned int count = this->list_float_size();
				data_size = 4UL * count;
				total_size += 1 *
					::google::protobuf::internal::FromIntSize(this->list_float_size());
				total_size += data_size;
			}

			// repeated string list_String = 3;
			total_size += 1 *
				::google::protobuf::internal::FromIntSize(this->list_string_size());
			for (int i = 0; i < this->list_string_size(); i++) {
			...
			// repeated .MSAnalyzer.MOSKIT_UNITY_LIB.Vector3 list_Vector3 = 4;
			{
				unsigned int count = this->list_vector3_size();
				total_size += 1UL * count;
				for (unsigned int i = 0; i < count; i++) {
					total_size +=
						::google::protobuf::internal::WireFormatLite::MessageSizeNoVirtual(
		...
		void AnalysisBuffer::MergeFrom(const ::google::protobuf::Message& from) {
			// @@protoc_insertion_point(generalized_merge_from_start:MSAnalyzer.MOSKIT_UNITY_LIB.AnalysisBuffer)
			if (GOOGLE_PREDICT_FALSE(&from == this)) MergeFromFail(__LINE__);
			const AnalysisBuffer* source =
				::google::protobuf::internal::DynamicCastToGenerated<const AnalysisBuffer>(
					&from);
			if (source == NULL) {
				// @@protoc_insertion_point(generalized_merge_from_cast_fail:MSAnalyzer.MOSKIT_UNITY_LIB.AnalysisBuffer)
				::google::protobuf::internal::ReflectionOps::Merge(from, this);
			}
			else {
				// @@protoc_insertion_point(generalized_merge_from_cast_success:MSAnalyzer.MOSKIT_UNITY_LIB.AnalysisBuffer)
				UnsafeMergeFrom(*source);
			}
		}

		void AnalysisBuffer::MergeFrom(const AnalysisBuffer& from) {
			// @@protoc_insertion_point(class_specific_merge_from_start:MSAnalyzer.MOSKIT_UNITY_LIB.AnalysisBuffer)
			if (GOOGLE_PREDICT_TRUE(&from != this)) {
				UnsafeMergeFrom(from);
			}
			else {
		...
		void AnalysisBuffer::UnsafeMergeFrom(const AnalysisBuffer& from) {
			GOOGLE_DCHECK(&from != this);
			list_int_.UnsafeMergeFrom(from.list_int_);
			list_float_.UnsafeMergeFrom(from.list_float_);
			list_string_.UnsafeMergeFrom(from.list_string_);
			list_vector3_.MergeFrom(from.list_vector3_);
			if (from._internal_metadata_.have_unknown_fields()) {
				::google::protobuf::UnknownFieldSet::MergeToInternalMetdata(
					from.unknown_fields(), &_internal_metadata_);
			}
		...
		void AnalysisBuffer::CopyFrom(const ::google::protobuf::Message& from) {
			// @@protoc_insertion_point(generalized_copy_from_start:MSAnalyzer.MOSKIT_UNITY_LIB.AnalysisBuffer)
			if (&from == this) return;
			Clear();
			MergeFrom(from);
		}

		void AnalysisBuffer::CopyFrom(const AnalysisBuffer& from) {
			// @@protoc_insertion_point(class_specific_copy_from_start:MSAnalyzer.MOSKIT_UNITY_LIB.AnalysisBuffer)
			if (&from == this) return;
			Clear();
			UnsafeMergeFrom(from);
		}

		bool AnalysisBuffer::IsInitialized() const {

			return true;
		}

		void AnalysisBuffer::Swap(AnalysisBuffer* other) {
			if (other == this) return;
			InternalSwap(other);
		}
		void AnalysisBuffer::InternalSwap(AnalysisBuffer* other) {
			list_int_.UnsafeArenaSwap(&other->list_int_);
			list_float_.UnsafeArenaSwap(&other->list_float_);
			list_string_.UnsafeArenaSwap(&other->list_string_);
			list_vector3_.UnsafeArenaSwap(&other->list_vector3_);
			std::swap(_has_bits_[0], other->_has_bits_[0]);
			_internal_metadata_.Swap(&other->_internal_metadata_);
			std::swap(_cached_size_, other->_cached_size_);
		}

		::google::protobuf::Metadata AnalysisBuffer::GetMetadata() const {
			protobuf_AssignDescriptorsOnce();
			::google::protobuf::Metadata metadata;
			metadata.descriptor = AnalysisBuffer_descriptor_;
			metadata.reflection = AnalysisBuffer_reflection_;
			return metadata;
		}
		...
		// repeated int32 list_Int = 1;
		int AnalysisBuffer::list_int_size() const {
			return list_int_.size();
		}
		void AnalysisBuffer::clear_list_int() {
			list_int_.Clear();
		}
		::google::protobuf::int32 AnalysisBuffer::list_int(int index) const {
			// @@protoc_insertion_point(field_get:MSAnalyzer.MOSKIT_UNITY_LIB.AnalysisBuffer.list_Int)
			return list_int_.Get(index);
		}
		void AnalysisBuffer::set_list_int(int index, ::google::protobuf::int32 value) {
			list_int_.Set(index, value);
			// @@protoc_insertion_point(field_set:MSAnalyzer.MOSKIT_UNITY_LIB.AnalysisBuffer.list_Int)
		}
		void AnalysisBuffer::add_list_int(::google::protobuf::int32 value) {
			list_int_.Add(value);
		...
		// repeated string list_String = 3;
		int AnalysisBuffer::list_string_size() const {
			return list_string_.size();
		}
		void AnalysisBuffer::clear_list_string() {
			list_string_.Clear();
		}
		const ::std::string& AnalysisBuffer::list_string(int index) const {
			// @@protoc_insertion_point(field_get:MSAnalyzer.MOSKIT_UNITY_LIB.AnalysisBuffer.list_String)
			return list_string_.Get(index);
		}
		::std::string* AnalysisBuffer::mutable_list_string(int index) {
		...
		void AnalysisBuffer::set_list_string(int index, const ::std::string& value) {
		...
		void AnalysisBuffer::set_list_string(int index, const char* value) {
			list_string_.Mutable(index)->assign(value);
			// @@protoc_insertion_point(field_set_char:MSAnalyzer.MOSKIT_UNITY_LIB.AnalysisBuffer.list_String)
		}
		void AnalysisBuffer::set_list_string(int index, const char* value, size_t size) {
		...
		// repeated .MSAnalyzer.MOSKIT_UNITY_LIB.Vector3 list_Vector3 = 4;
		int AnalysisBuffer::list_vector3_size() const {
			return list_vector3_.size();
		}
		void AnalysisBuffer::clear_list_vector3() {
			list_vector3_.Clear();
		}
		const ::MSAnalyzer::MOSKIT_UNITY_LIB::Vector3& AnalysisBuffer::list_vector3(int index) const {
			// @@protoc_insertion_point(field_get:MSAnalyzer.MOSKIT_UNITY_LIB.AnalysisBuffer.list_Vector3)
			return list_vector3_.Get(index);
		}
		::MSAnalyzer::MOSKIT_UNITY_LIB::Vector3* AnalysisBuffer::mutable_list_vector3(int index) {
		...
		::MSAnalyzer::MOSKIT_UNITY_LIB::Vector3* AnalysisBuffer::add_list_vector3() {
