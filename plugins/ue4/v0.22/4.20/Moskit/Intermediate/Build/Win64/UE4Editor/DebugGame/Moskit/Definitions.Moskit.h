...
#define ORIGINAL_FILE_NAME "UE4Editor-Moskit-Win64-DebugGame.dll"
#define UE_IS_ENGINE_MODULE 0
#define UE_BUILD_DEVELOPMENT_WITH_DEBUGGAME 1
#define UE_PROJECT_NAME ggd
...
#define _WINDOWS 1
#define NDEBUG 1
#define GOOGLE_PROTOBUF_CMAKE_BUILD 1
